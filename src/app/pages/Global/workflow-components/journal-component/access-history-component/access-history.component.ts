...
export class AccessHistoryComponent implements OnInit, OnChanges {
    ...
    constructor( private env: EnvService, private router: Router, private http: HttpClient, private toastr: ToastrService, private tokenStorage: TokenStorageService, private translateService: TranslateService) {
        // //console.log("historicEvent", this.historicacess)
        // let size = this.pageSize;
        // //console.log("historicTasks", this.historicacess)
        // this.historicacess = new CustomStore({
        //
        ...
        //             }
        //
        //             http.get(this.env.BackUrl + 'user-activities-OM/count' + paramsCount.substring(0, paramsCount.length - 1), {headers: new HttpHeaders().set("Authorization", tokenStorage.getToken())}).subscribe(data => {
        ...
        //                 }
        //
        //             return http.get(this.env.BackUrl + 'user-activities-OM?' + params, {headers: new HttpHeaders().set("Authorization", tokenStorage.getToken())})
        //                 .toPromise()
        //                 .then((data: any[]) => {
        //
        //                         return {
