...
@Component({
  selector: 'app-etude-opp',
  templateUrl: './etude-opp.component.html',
  styleUrls: ['./etude-opp.component.scss']
})
export class EtudeOppComponent implements OnInit {
    ...
    getAlletude() {
        ...
        this.dataSourceElement = new CustomStore({
            load: function (loadOptions: any) {
                ...
                return this.http.get(this.env.piOpp + 'etude-opps' + "?" + params + filterText, {headers: new HttpHeaders().set("Authorization", this.tokenStorage.getToken())})
                    .toPromise()
                    .then((data: any) => {
                            console.log(data)
  ...
  exportGrid() {
    ...
    showSuccess2() {
        this.toastr.show("Impossible de supprimer cette etude car elle est associée à une opp!", "Opération impossible", {
            titleClass: "center",
            messageClass: "center"
        });
    }
    showSuccess() {
        this.toastr.success(
            "Etude a été supprimée avec succès.",
            "Etude supprimée",
            {
                titleClass: "center",
                messageClass: "center"
